...
TEXTS = {
    "ru": {
        ...
        "paykassa_error": "⚠️ PayKassa временно не смогла создать счёт. Попробуйте оплату Stars или повторите позже. Ошибка записана в Railway Logs.",
    ...
    "en": {
        ...
        "paykassa_error": "⚠️ PayKassa could not create an invoice right now. Try Stars payment or repeat later. The error is logged in Railway Logs.",
