...
class Settings(BaseSettings):
    ...
    video_assets_duration_seconds: int = Field(30, alias="VIDEO_ASSETS_DURATION_SECONDS")
    video_assets_width: int = Field(720, alias="VIDEO_ASSETS_WIDTH")
    video_assets_height: int = Field(1280, alias="VIDEO_ASSETS_HEIGHT")
    video_assets_fps: int = Field(24, alias="VIDEO_ASSETS_FPS")
    video_assets_render_timeout_seconds: int = Field(120, alias="VIDEO_ASSETS_RENDER_TIMEOUT_SECONDS")
    ...
    matches_per_day: int = Field(7, alias="MATCHES_PER_DAY")
    ...
    max_candidates_for_ai: int = Field(24, alias="MAX_CANDIDATES_FOR_AI")
