...
class Settings(BaseSettings):
    ...
    bookmaker_search_url_template: str = Field("https://sportsbook.draftkings.com/sports/soccer", alias="BOOKMAKER_SEARCH_URL_TEMPLATE")
    bookmaker_backup_links_enabled: bool = Field(True, alias="BOOKMAKER_BACKUP_LINKS_ENABLED")
    bookmaker_backup_links: str = Field("BetMGM|https://www.betmgm.com/en/sports/soccer-4/betting;Favbet|https://www.favbet.ua/uk/sports", alias="BOOKMAKER_BACKUP_LINKS")
