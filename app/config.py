...
class Settings(BaseSettings):
    ...
    bookmaker_name: str = Field("Pinnacle", alias="BOOKMAKER_NAME")
    bookmaker_search_url_template: str = Field("https://www.pinnacle.com/en/search?s={query}", alias="BOOKMAKER_SEARCH_URL_TEMPLATE")
