...
def ukrainian_to_russian_text(value: str) -> str:
    ...
    replacements = {
        ...
        "висока ймовірність": "высокая вероятность",
        "високій ймовірності": "высокой вероятности",
    ...
    text = text.replace("матчей из ТБ", "матчей на ТБ")
    text = text.replace("матчей з ТБ", "матчей на ТБ")
    return text
