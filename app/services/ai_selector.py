...
ВАЖЛИВО:
- Для кожного обраного матчу поверни тексти двома мовами в полі localized:
  localized.uk — українською мовою.
  localized.ru — російською мовою.
- У localized.ru заборонено використовувати українські слова, форми або суржик.
- Старі верхньорівневі текстові поля можеш дублювати українською для сумісності, але localized.uk і localized.ru обов’язкові.
- Не змішуй мови всередині одного localized-блоку.
...
Ціль відбору:
- Якщо кандидатів достатньо, прагни вибрати 5-7 матчів, але не більше {self.settings.matches_per_day}.
- Кандидати вже пройшли первинний фільтр статистики та коефіцієнтів; не відхиляй матч лише через відсутність таблиці ліги, якщо форма/голи/odds підтримують OVER_1_5.
- Для товариських, резервних або менш популярних ліг будь обережним, але не відхиляй автоматично: оцінюй форму, голи за/проти, BTTS/Over 1.5 та доступний коефіцієнт.
- Якщо ризик не ідеальний, але ставка OVER_1_5 все ще логічна, можна залишити risk_level "середній" і confidence близько мінімального порогу.
...
{{
 "selected": [{{
  ...
  "localized": {{
   "uk": {{
    "match_title": "Команда A — Команда B",
    "main_bet_label": "Тотал більше 1.5",
    "safe_bet_label": "Тотал більше 1.5",
    "risky_bet_label": "Обидві заб’ють — так",
    "risk_level": "низький",
    "predicted_winner": "результат ризиковий",
    "who_should_score": "обидві можуть забити, але краще через тотал",
    "why_this_match_is_gold": "Український текст причини",
    "reasoning": "Український текст розбору"
   }},
   "ru": {{
    "match_title": "Команда A — Команда B",
    "main_bet_label": "Тотал больше 1.5",
    "safe_bet_label": "Тотал больше 1.5",
    "risky_bet_label": "Обе команды забьют — да",
    "risk_level": "низкий",
    "predicted_winner": "результат рискованный",
    "who_should_score": "обе могут забить, но лучше через тотал",
    "why_this_match_is_gold": "Русский текст причины без украинских слов",
    "reasoning": "Русский текст разбора без украинских слов"
   }}
  }},
